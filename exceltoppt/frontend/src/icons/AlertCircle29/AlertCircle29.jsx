...
export const AlertCircle29 = ({ color = "white", className }) => {
  return (
    <svg
      className={`alert-circle-29 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_2_2043)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_2_2043">
